...
export function SettingsPage() {
  ...
  const PRESENCE_OPTIONS = [
    { value: "online", label: "Online", color: "#1E88C7" },
  ...
  return (
    <div className="min-h-screen bg-[#12181A] text-white">
      <header className="flex items-center gap-4 bg-[#1B2326] px-4 py-3 border-b border-[#2A3438]">
        <a href="/" className="text-[#7E8A8C] hover:text-[#F2ECDF] transition-colors">
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        </a>
        <h1 className="text-lg font-semibold text-[#F2ECDF]">Settings</h1>
      </header>

      <div className="p-6 max-w-md space-y-6">
        <label className="block">
          <span className="text-sm font-medium text-[#7E8A8C]">Display name</span>
          <input
            value={displayName}
            onChange={(e) => setDisplayName(e.target.value)}
            className="mt-1.5 w-full rounded-xl bg-[#2E393C] px-4 py-2.5 text-[#F2ECDF] outline-none focus:ring-1 focus:ring-[#6EC6F0] border border-transparent focus:border-[#6EC6F0]"
          />
        </label>

        <label className="block">
          <span className="text-sm font-medium text-[#7E8A8C]">Username</span>
          <div className="relative mt-1.5">
            <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[#7E8A8C]">@</span>
            <input
              value={username}
              onChange={(e) => setUsername(e.target.value)}
              className="w-full rounded-xl bg-[#2E393C] py-2.5 pl-8 pr-4 text-[#F2ECDF] outline-none focus:ring-1 focus:ring-[#6EC6F0] border border-transparent focus:border-[#6EC6F0]"
            />
          </div>
        </label>

        <label className="block">
          <span className="text-sm font-medium text-[#7E8A8C]">Custom status</span>
          <input
            value={customStatus}
            onChange={(e) => setCustomStatus(e.target.value)}
            placeholder="In a meeting until 3pm..."
            className="mt-1.5 w-full rounded-xl bg-[#2E393C] px-4 py-2.5 text-[#F2ECDF] outline-none placeholder:text-[#7E8A8C] focus:ring-1 focus:ring-[#6EC6F0] border border-transparent focus:border-[#6EC6F0]"
          />
        </label>

        <div>
          <span className="text-sm font-medium text-[#7E8A8C]">Status</span>
              ...
              <button
                ...
                className={`flex items-center gap-2 rounded-xl border px-4 py-2.5 text-sm transition-all ${
                  presence === opt.value
                    ...
                    : "border-[#2A3438] text-[#7E8A8C] hover:border-[#6EC6F0]/50"
                }`}
        ...
        <button
          type="button"
          onClick={save}
          className="w-full rounded-xl bg-[#6EC6F0] py-3 font-semibold text-[#1B2326] hover:opacity-90 transition-opacity mt-4"
        >
